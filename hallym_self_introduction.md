...
```
  ...
  저의 공부내역은 깃허브 및 스토리에 업로드 하며 다른사람들에게 저의 경험을 공유하고 있습니다.
```
...
현업자들 보다 높은 결과를 기록하여 강사님께서 경진대회를 추천해주셨다. 데이콘과 같은 경진대회에 참여하여 내 점수가 올라가는 것을 보며 성취감을 느꼈고 AI 분야에 흥미를 가지게 된 것 같다.
