...
```
  ...
  올려준다고 생각하기에 케글 및 데이콘과 같은 경진대회에 참가하며 저의 경험을 늘리고 있습니다. 최근에는 딥러닝 가속 컴퓨팅 연구실에서
  학부 연구생으로 경험을 쌓고 있습니다. 다양한 사람들의 코드를 보며 저의 부족한 점을 보완하기도 하지만 코드를 공유하며 가독성을 높이기
  위해 간결하고 깔끔하게 짜는 것을 목표로 하여 발전하고 있습니다. 
  저의 공부내역은 깃허브 및 블로그에 업로드하며 다른 사람들에게 저의 경험을 공유하고 있습니다.
```
...
> 깃허브에 Star 기능은 관심 내용을 찾아보기 편하게 해준다. 나는 AI를 배우는데 이 [레포지토리](https://github.com/teddylee777/machine-learning)에 Star를 찍어두고 참조했던 적이 많다. 특강 강사님으로 위의 레포지토리를 만든 강사님과 다른 강사님 총 두 분께서 강의를 진행하였다. AI의 기초부터 딥러닝까지 개념 설명 후 경진대회처럼 score를 올리는 방식으로 진행했다. 내 분반은 다른 강사님이 진행하셔서 아쉬웠지만, 연예인을 실제로 보면 이런 기분일까 하며 재미있게 수업을 들었다. 마지막 날에 진행한 따릉이 수요 분석 대회에서 현업자 보다 높은 결과를 기록하여 강사님께서 데이콘 경진대회를 추천해주셨다. 실제로 강의 후에 다양한 데이콘 경진대회에 참가하게 되었으며, 점수가 올라가는 것을 보며 성취감을 느꼈다. 

# 📆 plan

- Github 하루 1잔디 심기
- YOLO 외에도 다양한 논문 읽기. 기회가 되면 정리해서 글로 올리기.
- CS231n 강의 전부 완주하기. (현재 2/16)
- 졸업 전까지 백준 알고리즘 플래티넘 달성.
...
- 2022년 05월 전국 대학생 축구대회 철원평화컵 한림대 소속 출전 16강<br>

## 🎤 마지막 한마디 
> 기존 이력서 방식과 깃허브의 장점인 Markdown Language의 장점을 살려서 밝은 성격을 보여드릴 수 있는 이력서를 만들어 보았습니다. <br>
> 개발자를 준비하는 과정에서 내가 어떤 활동을 하고 있고 어떤 점이 부족한지 알게 되었습니다. 
> 많이 부족한 저의 이력서를 읽어봐 주셔서 감사합니다. 좋은 대회를 만들어주셔서 감사드리며 긴 글을 읽어주셔서 감사합니다! 
