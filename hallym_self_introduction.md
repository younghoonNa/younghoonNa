...
🧑‍🤝‍🧑 I'm proceed with [CapstonDesign Project](https://github.com/seongjiko/DeepSeat_project) and [C.愛.랑 Algorithm study]() <br>
💬 If Give me Question [Click](https://github.com/younghoonNa/younghoonNa/issues) <br>

```
  안녕하세요 AI 개발자를 꿈꾸는 빅데이터 전공 18학번 나영훈입니다. 저는 데이콘 및 케글 경진대회에 참여하여 데이터 분석하는 것을 좋아합니다. 다양한 활동을 하며 저의 경험을 늘려가는 것이 저의 목표입니다. ...
  .. <br>
  .... ect <br>
```
...
- 2022년도 교내 학술동아리 C.愛.랑 알고리즘 스터디 진행
